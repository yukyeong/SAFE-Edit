...
ATTENTION_HEADS_EDIT_HEAD_CONFIG="${ATTENTION_HEADS_EDIT_HEAD_CONFIG:-configs/heads/api4_top100_a015_top30.json}"
...
mkdir -p logs/ffn_edit outputs/logs/manifests "${OUTPUT_ROOT}" "${SUMMARY_DIR}"
