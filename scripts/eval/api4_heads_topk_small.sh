...
RUN_NAME="${RUN_NAME:-api4_attention_heads_edit_top100_a015_fixed_topN_small_$(date +%H%M%S)}"
...
echo "[INFO] alpha=0.15 scale_position=include_down fixed_topN=10,15,20"
nvidia-smi || true

METHODS_JSON=""
for N in 10 15 20; do
  METHOD="Attention_Heads_Edit_top100_a015_fixed_top${N}"
  HEAD_CONFIG="configs/heads/api4_top100_a015_top${N}.json"
