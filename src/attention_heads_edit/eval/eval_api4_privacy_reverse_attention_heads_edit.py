...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=REPO_ROOT
        / "configs/heads/api4_top100_a015_top30.json",
    )
...
def apply_ffn_edit_if_requested(model, args: argparse.Namespace) -> list[list[int]]:
    ...
    if "gemma" in model_type:
        from ffn_edit.hooks.custom_gemma import install_static_gemma_ffn_edit_hooks

        install_static_gemma_ffn_edit_hooks(model, positions, "remove")
        setattr(args, "ffn_edit_backend", "gemma_down_proj_pre_hook")
    elif "qwen" in model_type:
        from ffn_edit.hooks.custom_qwen import install_static_qwen_ffn_edit_hooks
        ...
        from ffn_edit.hooks.custom_ministral import install_static_ministral_ffn_edit_hooks
